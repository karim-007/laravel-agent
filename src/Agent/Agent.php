...
namespace Karim007\LaravelAgent\Agent;
...
class Agent extends MobileDetect
{
     ...
     * @return string|bool
     */
    public function browser($userAgent = null): bool|string
    {
        return $this->findDetectionRulesAgainstUA(static::getBrowsers(), $userAgent??\request()->userAgent());
    }
    ...
    {
        return $this->findDetectionRulesAgainstUA(static::getPlatforms(), $userAgent??\request()->userAgent());
    }
    ...
    public function device($userAgent = null)
    {
        ...
        return $this->findDetectionRulesAgainstUA($rules, $userAgent??\request()->userAgent());
    }
